...
export const analysisResources: AnalysisResource[] = [
  {
    id: "yt-caspian-gulf-deterrence",
    type: "VIDEO",
    title: "Why Gulf deterrence keeps cycling between pressure and restraint",
    summary: "A strategic breakdown of naval chokepoints, proxy signaling, sanctions leverage, and the escalation logic between Washington, Tehran, and their partners.",
    source: "CaspianReport",
    url: "https://www.youtube.com/watch?v=abc123xyz01",
    publishedAt: "2026-04-25T16:00:00Z",
    region: "Middle East",
    topics: ["US-Iran", "Maritime Security", "Deterrence"],
    analyst: "CaspianReport",
    platform: "YouTube",
  },
  {
    id: "yt-zeihan-ukraine-aid",
    type: "VIDEO",
    title: "Ukraine attrition, Western aid, and the next escalation ladder",
    summary: "Explains how battlefield tempo, industrial replenishment, and alliance politics shape the Russia-Ukraine war over the next quarter.",
    source: "Zeihan on Geopolitics",
    url: "https://www.youtube.com/watch?v=def456uvw02",
    publishedAt: "2026-04-24T18:30:00Z",
    region: "Eastern Europe",
    topics: ["Russia-Ukraine", "Military", "Western Aid"],
    analyst: "Peter Zeihan",
    platform: "YouTube",
  },
  {
    id: "article-cfr-taiwan",
    type: "ARTICLE",
    title: "Taiwan Strait pressure campaign and the risk of miscalculation",
    summary: "A policy-style analysis of gray-zone coercion, alliance signaling, and how quickly a military demonstration could spill into crisis.",
    source: "Council on Foreign Relations",
    url: "https://www.cfr.org/",
    publishedAt: "2026-04-24T10:00:00Z",
    region: "East Asia",
    topics: ["Taiwan", "China", "Deterrence"],
    analyst: "CFR",
    platform: "Article",
  },
  {
    id: "article-iiss-redsea",
    type: "ARTICLE",
    title: "Red Sea insecurity, supply chains, and proxy leverage",
    summary: "Looks at how regional armed groups turn shipping disruption into strategic leverage and what outside powers can realistically deter.",
    source: "IISS",
    url: "https://www.iiss.org/",
    publishedAt: "2026-04-23T14:20:00Z",
    region: "Middle East",
    topics: ["Red Sea", "Shipping", "Proxy Warfare"],
    analyst: "IISS",
    platform: "Article",
  },
  {
    id: "article-rusi-pak-india",
    type: "ARTICLE",
    title: "India-Pakistan crisis stability in a high-noise information environment",
    summary: "Reviews escalation triggers, military signaling, and the role of information warfare during fast-moving South Asia crises.",
    source: "RUSI",
    url: "https://www.rusi.org/",
    publishedAt: "2026-04-22T11:45:00Z",
    region: "South Asia",
    topics: ["India", "Pakistan", "Nuclear Risk"],
    analyst: "RUSI",
    platform: "Article",
  },
  {
    id: "article-isw-ukraine",
    type: "ARTICLE",
    title: "Operational pressure points across the Ukraine theater",
    summary: "Tracks where incremental territorial pressure, logistics strain, and force generation trends could alter the tactical picture.",
    source: "Institute for the Study of War",
    url: "https://www.understandingwar.org/",
    publishedAt: "2026-04-25T08:15:00Z",
    region: "Eastern Europe",
    topics: ["Ukraine", "Russia", "Frontline Analysis"],
    analyst: "ISW",
    platform: "Article",
  },
];
